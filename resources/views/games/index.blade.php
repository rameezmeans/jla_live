...
<nav class="navbar navbar-default navbar-static-top bg-dark">
    ...
    <div class="col-md-8 col-md-offset-2">
        ...
        @if($admin)
        <div class="row">
            <div class="col-md-12 text-center"><a href="#" class="add-modal">Add a Game</a></div>
        </div>
        @endif
        <br />
                            ...
                            @foreach($games as $indexKey => $game)
                                <tr class="item{{$game->id}} @if($game->is_published) warning @endif">
                                    ...
                                    @if($admin)
                                        ...
                                        <td>
                                            <button class="show-modal btn btn-success" data-id="{{$game->id}}" data-name="{{$game->name}}" data-content="{{$game->content}}">
                                            <span class="glyphicon glyphicon-eye-open"></span> Show</button>
                                            <button class="edit-modal btn btn-info" data-id="{{$game->id}}" data-name="{{$game->name}}" data-content="{{$game->content}}">
                                            <span class="glyphicon glyphicon-edit"></span> Edit</button>
                                            <button class="delete-modal btn btn-danger" data-id="{{$game->id}}" data-name="{{$game->name}}" data-content="{{$game->content}}">
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if ((data.errors)) {
                        ...
                        $('#postTable').prepend("<tr class='item" + data.id + "'><td class='col1'>" + data.id + "</td><td>" + data.name + "</td><td>Just now!</td><td><button class='show-modal btn btn-success' data-id='" + data.id + "' data-name='" + data.name + "' data-content='" + data.content + "'><span class='glyphicon glyphicon-eye-open'></span> Show</button> <button class='edit-modal btn btn-info' data-id='" + data.id + "' data-name='" + data.name + "' data-content='" + data.content + "'><span class='glyphicon glyphicon-edit'></span> Edit</button> <button class='delete-modal btn btn-danger' data-id='" + data.id + "' data-name='" + data.name + "' data-content='" + data.content + "'><span class='glyphicon glyphicon-trash'></span> Delete</button></td></tr>");
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if ((data.errors)) {
                        ...
                        toastr.success('Successfully updated Game!', 'Success Alert', {timeOut: 5000});
                        $('.item' + data.id).replaceWith("<tr class='item" + data.id + "'><td class='col1'>" + data.id + "</td><td>" + data.name + "</td><td>Right now</td><td><button class='show-modal btn btn-success' data-id='" + data.id + "' data-name='" + data.name + "' data-content='" + data.content + "'><span class='glyphicon glyphicon-eye-open'></span> Show</button> <button class='edit-modal btn btn-info' data-id='" + data.id + "' data-name='" + data.name + "' data-content='" + data.content + "'><span class='glyphicon glyphicon-edit'></span> Edit</button> <button class='delete-modal btn btn-danger' data-id='" + data.id + "' data-name='" + data.name + "' data-content='" + data.content + "'><span class='glyphicon glyphicon-trash'></span> Delete</button></td></tr>");
