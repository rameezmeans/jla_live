...
<head>
    ...
    <title>JLA | Game Detail Page</title>
    ...
    <table class="table table-striped table-hover" id="postTable" style="visibility: hidden;">
        ...
        @foreach($gamerecords as $indexKey => $gamerecord)
            <tr class="item{{$gamerecord->id}} @if($gamerecord->is_published) warning @endif">
                ...
                <td>{{ $gamerecord->minutes  }}</td>
                <td>@if($gamerecord->starter){{  'YES' }} @else {{'No'}} @endif</td>
                <td>{{ $gamerecord->goals }}</td>
                <td>{{ $gamerecord->assists }}</td>
                <td class="end">{{ $gamerecord->points }}</td>
                <td>{{ $gamerecord->shots }}</td>
                <td>{{ $gamerecord->shots_percentage }}</td>
                <td>{{ $gamerecord->sog }}</td>
                <td>{{ $gamerecord->sog_percentage }}</td>
                <td>{{ $gamerecord->manup }}</td>
                <td class="end">{{ $gamerecord->down }}</td>
                <td>{{ $gamerecord->ground_ball }}</td>
                <td>{{ $gamerecord->TO }}</td>
                <td class="end">{{ $gamerecord->CTO }}</td>
                <td>{{ $gamerecord->win }}</td>
                <td>{{ $gamerecord->lose }}</td>
                <td class="end">{{ $gamerecord->FO_percentage }}</td>
                <td>{{ $gamerecord->allowed }}</td>
                <td>{{ $gamerecord->saved }}</td>
                <td>{{ $gamerecord->save_percentage }}</td>
                @if($admin)
                    ...
                    <td style="display: inline-flex;">
                        <button class="edit-modal btn btn-info"
                                ...
                                data-manup="{{$gamerecord->manup}}"
                                data-down="{{$gamerecord->down}}"
                                data-ground_ball="{{$gamerecord->ground_ball}}"
                                data-to="{{$gamerecord->TO}}"
                                data-cto="{{$gamerecord->CTO}}"
                                data-win="{{$gamerecord->win}}"
                                data-lose="{{$gamerecord->lose}}"
                                data-allowed="{{$gamerecord->allowed}}"
                                data-saved="{{$gamerecord->saved}}"
                                >
                            <span   class="glyphicon glyphicon-edit"></span></button>
                        <button class="delete-modal btn btn-danger" data-id="{{$gamerecord->id}}" data-name="{{$gamerecord->name}}">
...
<div id="addModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <input id="gamelog_id_add" type="hidden" value="{{ $gamelog->id }}">
            <div class="modal-body">
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="number" min="1" value="1" class="form-control" id="minutes_add" >
