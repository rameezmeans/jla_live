...
<div class="col-md-12">
    <div class="row">
        <div class="col-md-12"><h2 class="text-center">{{ $team->name }}</h2></div>
    </div>
    <br />
...
<div class="col-md-12">
    <div class="row">
        <div class="col-md-12"><h2 class="text-center">Schedule</h2></div>
        <div class="col-md-12"><p class="text-center">Season Record:</p></div>
    </div>
    <br />
...
<div class="col-md-12">
    <div class="row">
        <div class="col-md-12"><h2 class="text-center">Roster</h2></div>
    </div>
    <br />
